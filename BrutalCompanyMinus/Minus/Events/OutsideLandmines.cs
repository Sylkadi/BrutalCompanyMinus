...
namespace BrutalCompanyMinus.Minus.Events
{
    internal class OutsideLandmines : MEvent
    {
        ...
        public override void Initalize()
        {
            ...
            Weight = 3;
            Descriptions = new List<string>() { "There are landmines, Outside.", "This facility also has setup it's own booby traps outside", "What your step... but outside", "Iraq" };
            ColorHex = "#FF0000";
            Type = EventType.Bad;

            ScaleList.Add(ScaleType.MinDensity, new Scale(0.003f, 0.0001f, 0.003f, 0.009f));
            ScaleList.Add(ScaleType.MaxDensity, new Scale(0.0042f, 0.00014f, 0.0042f, 0.00126f));
        }
