...
namespace BrutalCompanyMinus.Minus.Events
{
    internal class TransmuteScrapSmall : MEvent
    {
        ...
        public override void Initalize()
        {
            ...
            EventsToRemove = new List<string>() { nameof(TransmuteScrapBig), nameof(Dentures), nameof(Pickles), nameof(GoldenFacility), nameof(Honk), nameof(GoldenBars), nameof(CursedGold) };
